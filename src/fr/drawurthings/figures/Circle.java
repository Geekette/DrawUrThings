...
public class Circle extends Drawable{
	...
	public Circle(int originX, int originY,int width, int height, int layer){
	...
	public Circle(int originX, int originY,int width, int height, int layer, Color border){
		this(originX, originY,width, height, layer);
		this.border = border;
	}
	
	public Circle(int originX, int originY,int width, int height, int layer, Color border,Color fill){
