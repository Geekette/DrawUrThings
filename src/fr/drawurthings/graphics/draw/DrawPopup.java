...
public class DrawPopup extends JPopupMenu{
	...
	private void buildForFigure(){
		...
		colorFill = new JMenuItem("Remplissage",new ImageIcon("ressources/icon/color_pencil.png"));
		colorFill.addActionListener(pl);
		colorBW = new JMenuItem("Passer en noir et blanc", new ImageIcon("ressources/icon/color_minus.png"));
		colorBW.addActionListener(pl);
		...
		arrangeup = new JMenuItem("Monter", new ImageIcon("ressources/icon/new.png"));
		arrangeup.addActionListener(pl);
		arrangedown = new JMenuItem("Descendre", new ImageIcon("ressources/icon/minus.png"));
		arrangedown.addActionListener(pl);
		arrangeback = new JMenuItem("Mettre en arrière plan", new ImageIcon("ressources/icon/layer_shade.png"));
		...
		this.properties = new JMenuItem("Propriétés", new ImageIcon("ressources/icon/pencil.png"));
	...
	private void buildForBackground(){
		...
		undo = new JMenuItem("Annuler", new ImageIcon("ressources/icon/undo.png"));
		undo.addActionListener(pl);
		redo = new JMenuItem("Refaire", new ImageIcon("ressources/icon/redo.png"));
		redo.addActionListener(pl);
		deleteall = new JMenuItem("Tout supprimer", new ImageIcon("ressources/icon/remove.png"));
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(figure != null){
				try{
					...
					}else if(source.equals(colorBW)){
						p.setFigureBorderColor(figure.getLayer(), Color.BLACK);
						p.setFigureFillingColor(figure.getLayer(), Color.WHITE);
					}else{
